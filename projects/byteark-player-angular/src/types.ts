...
declare global {
  interface Window {
    bytearkPlayer: {
      ...
      VERSION: string;
      setup: SetupPlayerFunction;
      init: CreatePlayerFunction;
      initAsync: CreatePlayerFunction;
...
export interface ByteArkPlayerContainerProps extends ByteArkPlayerOptions {
  ...
  onPlayerLoaded?: OnPlayerLoadedFunction;
  onPlayerLoadError?: OnPlayerLoadErrorFunction;
  onReady?: OnPlayerReadyFunction;
  onPlayerSetup?: OnPlayerSetupFunction;
  onPlayerSetupError?: OnPlayerSetupErrorFunction;
...
export type OnPlayerLoadedFunction = () => void;
...
export type OnPlayerSetupFunction = () => void;
